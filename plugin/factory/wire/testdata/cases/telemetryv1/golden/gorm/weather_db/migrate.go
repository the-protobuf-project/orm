...
// Package weatherdb wires every model generated for the weather_db database
...
//
//	if err := weatherdb.Default.EnsureSchemas(db); err != nil {
//		log.Fatal(err)
//	}
//	if err := weatherdb.Default.Migrate(db); err != nil {
//		log.Fatal(err)
//	}
...
// Default holds every model generated for the weather_db database. Attach it
...
//
//	weatherdb.Default.Register(&MyModel{})
...
//	}
//	defer o.Close()
//	if err := weatherdb.Default.Instrument(db, o); err != nil {
//		log.Fatal(err)
//	}
