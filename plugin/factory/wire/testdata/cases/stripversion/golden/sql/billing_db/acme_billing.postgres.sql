...
COMMENT ON TABLE "acme_billing"."invoices" IS 'Invoice lands in schema "acme_billing", not "acme_billing_v1": the orm.yaml strip_version option flattens the trailing API version out of the resource-type-derived schema name.';
